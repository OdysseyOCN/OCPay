...
@interface QRCodeViewController () <SGQRCodeScanManagerDelegate, SGQRCodeAlbumManagerDelegate>
...
- (void)callBackResult:(NSString*)result{
    NSLog(@"二维码识别结果：%@",result);
    [self.navigationController popViewControllerAnimated:NO];
    if (self.reciveResult){
        self.reciveResult(result);
    }
}
...
- (SGQRCodeScanningView *)scanningView {
    if (!_scanningView) {
        ...
        _scanningView.cornerColor = [UIColor colorWithRGB:0x38525F];
    }
...
- (UILabel *)promptLabel {
    if (!_promptLabel) {
        ...
        _promptLabel.text = @"Align the QR Code within the frame to scan";
    }
    return _promptLabel;
}
